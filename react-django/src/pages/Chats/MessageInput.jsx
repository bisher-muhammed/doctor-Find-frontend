...
import { FaFile, FaMicrophone, FaPlay, FaPause, FaPaperPlane } from 'react-icons/fa';
...
const MessageInput = ({ roomId, socket, user, baseURL, token }) => {
  ...
  }, [newMessage, file, fileType, recordedAudios, baseURL, token, roomId, socket, user]);
